  ...
  <!-- Verifica que el usuario que este logueado tenga el roll de aprendiz si no lo debuelve al login -->
  <?php session_start(); if ($_SESSION['cargo'] != 'aprendiz') {    header('location:'.base_url('index.php/login'));} ?>
  <!-- Submenu -->
  <div id="menu_modal">
      ...
      <div id="modal_2">
          <ul class="list-group">
              <a href="<?php echo(base_url('index.php/login/informacion_adicional'));?>" ><li class="list-group-item mo" >Configurar cuenta</li></a>
